...
export const FALLBACK_FEATURED_WORKS = [
  {
    id: -106,
    title: "Elegant Maroon Portrait",
    description: "A stunning studio portrait capturing elegance in traditional maroon attire.",
    category: "photography" as const,
    imageUrl: "/assets/portfolio/featured-1.jpg",
    imageKey: "featured-1",
    featured: true,
    order: -106,
    createdAt: new Date(),
  ...
  {
    id: -105,
    title: "Chic Studio Session",
    description: "Modern studio photography featuring bold colors and sophisticated styling.",
    category: "photography" as const,
    imageUrl: "/assets/portfolio/featured-2.jpg",
    imageKey: "featured-2",
    featured: true,
    order: -105,
    createdAt: new Date(),
  ...
  },
  {
    ...
    description: "Elegant bridal photography capturing the beauty of the ceremony.",
    category: "photography" as const,
    imageUrl: "/assets/portfolio/nuru_sana_2.webp",
    imageKey: "nuru-sana-2",
    featured: true,
    order: -103,
    createdAt: new Date(),
    updatedAt: new Date()
  ...
  {
    id: -102,
    title: "NURU ❤️ SANA AFFAIRS 2026 - Couple",
    description: "Beautiful couple moments from the Nuru & Sana wedding.",
    category: "photography" as const,
    imageUrl: "/assets/portfolio/nuru_sana_3.webp",
    imageKey: "nuru-sana-3",
    featured: true,
    order: -102,
    createdAt: new Date(),
    updatedAt: new Date()
  ...
  {
    id: -101,
    title: "NURU ❤️ SANA AFFAIRS 2026 - Celebration",
    description: "Joyful celebration moments from the Nuru & Sana wedding.",
    category: "photography" as const,
    imageUrl: "/assets/portfolio/nuru_sana_4.webp",
    imageKey: "nuru-sana-4",
    featured: true,
    order: -101,
    createdAt: new Date(),
    updatedAt: new Date()
